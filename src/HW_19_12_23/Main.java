...
public class Main {
     ...
     */
     public static void main(String[] args) {
         ...
         Plant flower = new Flower("Tulip","30",1);
         Plant tree = new Tree("Cherries","200",1);
         Plant[] plants = {flower,tree};

         System.out.println(" Growing plants for 1 years  :  ");

         for(Plant y : plants){
             System.out.println(y);
             if(y.equals(flower)){
                 flower.doSpring();flower.doSummer();flower.doAutumn();flower.doWinter();
                 System.out.println();
             }
             if(y.equals(tree)){
                 tree.doSpring();tree.doSummer();tree.doAutumn();tree.doWinter();
             }
         }
     }
}
